  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="bg-white p-4 rounded-lg shadow">
        <h3 className="text-lg font-semibold mb-3 sm:mb-4">Vues</h3>
        <div className="flex flex-wrap gap-2 sm:gap-3">
          <Button
            onClick={() => setViewMode('detailed')}
            className={`${
              viewMode === 'detailed' ? 'bg-blue-700' : 'bg-blue-600 hover:bg-blue-700'
            } text-white text-sm sm:text-base py-2 px-3 sm:px-4 min-w-[100px] sm:min-w-[120px]`}
          >
            📋 Détaillé
          </Button>
          <Button
            ...
            className={`${
              viewMode === 'declaration' ? 'bg-blue-700' : 'bg-blue-600 hover:bg-blue-700'
            } text-white text-sm sm:text-base py-2 px-3 sm:px-4 min-w-[100px] sm:min-w-[120px]`}
          >
            🧾 Déclaration CNPS
          </Button>
          <Button
            ...
            className={`${
              viewMode === 'dipe' ? 'bg-blue-700' : 'bg-blue-600 hover:bg-blue-700'
            } text-white text-sm sm:text-base py-2 px-3 sm:px-4 min-w-[100px] sm:min-w-[120px]`}
          >
            🧾 DIPE
          </Button>
          <Button
            onClick={() => setViewMode('impots')}
            className={`${
              viewMode === 'impots' ? 'bg-blue-700' : 'bg-blue-600 hover:bg-blue-700'
            } text-white text-sm sm:text-base py-2 px-3 sm:px-4 min-w-[100px] sm:min-w-[120px]`}
          >
            💰 Impôts
          </Button>
      ...
      {/* Actions */}
      <div className="bg-white p-4 rounded-lg shadow">
        <h3 className="text-lg font-semibold mb-3 sm:mb-4">Actions</h3>
        <div className="flex flex-wrap gap-2 sm:gap-3">
          <Button
            onClick={onReloadFromPayslips}
            className="bg-blue-600 hover:bg-blue-700 text-white text-sm sm:text-base py-2 px-3 sm:px-4 min-w-[100px] sm:min-w-[120px]"
          ...
          <Button
            onClick={onSave}
            className="bg-green-600 hover:bg-green-700 text-white text-sm sm:text-base py-2 px-3 sm:px-4 min-w-[100px] sm:min-w-[120px]"
          ...
          <Button
            ...
            className="bg-red-600 hover:bg-red-700 text-white text-sm sm:text-base py-2 px-3 sm:px-4 min-w-[100px] sm:min-w-[120px]"
          ...
          <Button
            ...
            className="bg-purple-600 hover:bg-purple-700 text-white text-sm sm:text-base py-2 px-3 sm:px-4 min-w-[100px] sm:min-w-[120px]"
            disabled={selectedIds.length === 0}
          >
            📄 Export PDF Impôts
          </Button>
