// src/components/EmployeeMobileFooterNav.jsx
// Navigation footer pour mobile/tablette pour les employés
...
const EmployeeMobileFooterNav = ({ activeTab, setActiveTab, notificationCount = 0, handleLogout }) => {
  const [showToolsMenu, setShowToolsMenu] = useState(false);
  
  // Sections principales pour les employés
  const mainItems = [
  ...
  // Outils (regroupés dans le menu "Plus")
  const toolsItems = [
    { id: "leaves", label: "Congés", icon: FiCalendar },
    { id: "contract", label: "Contrat", icon: FiFileText },
    { id: "overtime", label: "Heures Sup", icon: FiClock },
  ...
  return (
    <>
      ...
      {/* Footer Navigation - Visible uniquement sur mobile/tablette, cachée sur desktop */}
...
export default EmployeeMobileFooterNav;
